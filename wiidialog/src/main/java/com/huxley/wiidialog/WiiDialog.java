...
public class WiiDialog {

  private static final int INVALID = -1;

  /**
   * WiiDialog base layout root view
   */
  private final ViewGroup rootView;

  /**
   * WiiDialog content container which is a different layout rather than base layout
   */
  ...
  WiiDialog(WiiDialogBuilder builder) {
  ...
  public static WiiDialogBuilder newDialog(Context context) {
    return new WiiDialogBuilder(context);
  }
        ...
        decorView.post(new Runnable() {
          @Override public void run() {
            ...
            if (onDismissListener != null) {
              onDismissListener.onDismiss(WiiDialog.this);
            }
          }
        });
      }
  ...
  private void setClickListener(View view) {
    ...
    view.setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View v) {
        ...
        onClickListener.onClick(WiiDialog.this, v);
      }
    });
  }
          ...
          case KeyEvent.ACTION_UP:
            if (keyCode == KeyEvent.KEYCODE_BACK) {
              if (onBackPressListener != null) {
                onBackPressListener.onBackPressed(WiiDialog.this);
              }
              if (isCancelable) {
                onBackPressed(WiiDialog.this);
              }
              return true;
            }
            break;
   ...
   *
   * @param wiiDialog is the current dialog
   */
  public void onBackPressed(WiiDialog wiiDialog) {
    if (onCancelListener != null) {
      onCancelListener.onCancel(WiiDialog.this);
    }
    dismiss();
  }
