...
public class WiiDialogBuilder {
   ...
   */
  public WiiDialogBuilder setAdapter(BaseAdapter adapter) {
    if (adapter == null) {
   ...
   */
  public WiiDialogBuilder setFooter(int resourceId) {
   ...
   */
  public WiiDialogBuilder setFooter(View view) {
   ...
   */
  public WiiDialogBuilder setHeader(int resourceId) {
   ...
   */
  public WiiDialogBuilder setHeader(View view) {
   ...
   */
  public WiiDialogBuilder setCancelable(boolean isCancelable) {
   ...
   */
  public WiiDialogBuilder setContentHolder(Holder holder) {
    this.holder = holder;
    return this;
  }
   ...
   */
  @Deprecated public WiiDialogBuilder setBackgroundColorResId(int resourceId) {
   ...
   */
  public WiiDialogBuilder setContentBackgroundResource(int resourceId) {
    this.contentBackgroundResource = resourceId;
    return this;
  }

  public WiiDialogBuilder setOverlayBackgroundResource(int resourceId) {
   ...
   */
  public WiiDialogBuilder setGravity(int gravity) {
   ...
   */
  public WiiDialogBuilder setInAnimation(int inAnimResource) {
   ...
   */
  public WiiDialogBuilder setOutAnimation(int outAnimResource) {
   ...
   * are applied
   */
  public WiiDialogBuilder setOutMostMargin(int left, int top, int right, int bottom) {
   ...
   * are applied
   */
  public WiiDialogBuilder setMargin(int left, int top, int right, int bottom) {
    this.margin[0] = left;
    this.margin[1] = top;
    this.margin[2] = right;
   ...
   */
  public WiiDialogBuilder setPadding(int left, int top, int right, int bottom) {
    this.padding[0] = left;
    this.padding[1] = top;
   ...
   */
  public WiiDialogBuilder setOnClickListener(OnClickListener listener) {
    this.onClickListener = listener;
    return this;
  }

  public WiiDialogBuilder setOnDismissListener(OnDismissListener listener) {
    this.onDismissListener = listener;
    return this;
  }

  public WiiDialogBuilder setOnCancelListener(OnCancelListener listener) {
    this.onCancelListener = listener;
    return this;
  }

  public WiiDialogBuilder setOnBackPressListener(OnBackPressListener listener) {
    this.onBackPressListener = listener;
    return this;
  }

  public WiiDialogBuilder setExpanded(boolean expanded) {
    this.expanded = expanded;
    return this;
  }

  public WiiDialogBuilder setExpanded(boolean expanded, int defaultContentHeight) {
    this.expanded = expanded;
    this.defaultContentHeight = defaultContentHeight;
    return this;
  }

  public WiiDialogBuilder setContentHeight(int height) {
    params.height = height;
    return this;
  }

  public WiiDialogBuilder setContentWidth(int width) {
    params.width = width;
    return this;
  }
